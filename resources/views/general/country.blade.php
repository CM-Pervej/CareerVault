...
<div class="container mx-auto max-w-6xl px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Countries</h1>
            <p class="text-sm text-slate-500 mt-1">
                Manage the countries used across your workspace.
            </p>
        </div>
        ...
        <div class="hidden sm:flex items-center gap-2 bg-white border border-slate-200 rounded-xl px-4 py-2 shadow-sm">
            ...
            <div class="leading-tight">
                ...
                <p class="text-sm font-semibold text-slate-800">{{ $countries->total() }} countries</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm mb-6">
        <div class="p-6">
            ...
            <form
                action="{{ isset($country) ? route('countries.update', $country) : route('countries.store') }}"
                method="POST"
                autocomplete="off"
                ...
                <fieldset class="flex-1">
                    ...
                    <input
                        ...
                        placeholder="e.g. Bangladesh, Canada, Japan">
                        ...
                        <tr
                            ...
                            <td class="px-4 py-3">
                                <div class="flex gap-2">
                                    ...
                                    <a
                                        href="{{ route('countries.edit', $item) }}"
                                    ...
                                    <button
                                        ...
                                        data-action="{{ route('countries.destroy', $item) }}"
                                        data-name="{{ $item->name }}">
